...
<span class="nav-span"><button id="update-marketing-services-performed" type="button" class="big-button" onclick="update_marketing_services_performed();">Update Services Performed</button></span>
<br>

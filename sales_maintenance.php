...
<button id="create-new-customer" type="button" class="big-button hidden-elm" onclick="alert('New Customer Button');">New Customer</button>
<button id="modify-customer" type="button" class="big-button hidden-elm" onclick="alert('Mod Customer Button');">Modify Customer</button>
</div>
